...
def apply_rope() -> Model:
    ...
    xq_shape = xq.get_shape()
    xk_shape = xk.get_shape()
...
def attention() -> Model:
    ...
    context_shape = block.context.get_shape()  # type: ignore[attr-defined]
...
def double_stream_block(
    ...
    # TODO: use'[:, txt.get_shape()[1] :]' when fixed.
