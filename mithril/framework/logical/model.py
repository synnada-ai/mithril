    ...
    def extend(
        ...
        **kwargs: ConnectionType,
        ...
        for c_input in model.conns.cins:
            ...
            if c_in is not None and c_in not in self.dependency_map.local_output_dependency_map and c_in in self.conns.input_connections and c_in.metadata.data.value is TBD:
