...
g_tensor *relu_grad(g_context *ctx, g_tensor *output_grad, int idx, g_tensor *output,
                    g_tensor *input);
g_tensor *squared_error_grad(g_context *ctx, g_tensor *gradient, int idx, g_tensor *output,
                             g_tensor *left, g_tensor *right);
g_tensor *reduce_mean_grad(g_context *ctx, g_tensor *gradient, int idx, g_tensor *left,
                           g_tensor *right, g_tensor *axes, g_tensor *keepdim);
