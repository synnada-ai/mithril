...
def test_set_types_1():
    model = Model()
    sig_model = Sigmoid()
    model += sig_model.connect(input="input", output=IOKey("output"))
...
def test_set_types_2():
    model = Model()
    buffer_model = Buffer()
    model += buffer_model.connect(input="input", output=IOKey(name="output"))
...
def test_set_types_5():
    ...
    model |= buffer_model_1.connect(input="input1", output=IOKey(name="output1"))
    model |= buffer_model_2.connect(input="input2", output=IOKey(name="output2"))
...
def test_set_types_7():
    ...
    model += item_model.connect(input="input", output=IOKey("output"))
...
def test_set_types_9():
    ...
    model4 = Model()
    item_model = Indexer(index=1)
    model1 += item_model.connect(input="input", output=IOKey("output"))
    model2 += model1.connect(input="input", output=IOKey("output"))
    model3 += model2.connect(input="input", output=IOKey("output"))
    model4 += model3.connect(input="input", output=IOKey("output"))
...
def test_types_iokey_1():
    model = Model()
    buffer_model = Buffer()
    model += buffer_model.connect(
        input="input", output=IOKey(name="output", type=Tensor[int])
    )
    output_data = model.output.metadata  # type: ignore
    input_data = model.input.metadata  # type: ignore
...
def test_types_iokey_3():
    ...
    buffer_model2 = Buffer()
    model |= buffer_model1.connect(
        input=IOKey(name="input1", type=Tensor[bool | float])
    )
    model |= buffer_model2.connect(
    ...
    model |= buffer_model3.connect(input="input", output="sub")
...
def test_set_types_connection():
    model = Model()
    buf_model = Buffer()
    model += buf_model.connect(input="input", output=IOKey("output"))
...
def test_set_types_connection_without_model():
    ...
    model = Model()
    buf_model = Buffer()
    model += buf_model.connect(input=in_con, output=IOKey("output"))
