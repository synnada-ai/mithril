...
def test_3():
    ...
    model.expose_keys("output1", "output")
    model_2 = model
...
def test_5():
    ...
    model |= sig3.connect(input="sub_out2", output="output")
    model.expose_keys("output", output1="sub_out1", output2="sub_out2")
...
def test_6():
    ...
    model.expose_keys("output", output1="sub_out1")
...
def test_7():
    ...
    model.expose_keys("sub_out1", "sub_out2", "output")
...
def test_8():
    ...
    model.expose_keys(sig1.output, sig2.output, "output")
...
def test_5_error():
    ...
    assert error_text == ("'Connection without a name cannot be set as output'")
