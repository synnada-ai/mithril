...
def test_mlp_1_static_shapes():
    ...
    physical_ref = {
        "input": [100, 4],
        "w0": [5, 4],
        "_MLP_0_Layer_0_Linear_0_Transpose_0_axes": None,
        ...
        "w1": [10, 5],
        "_MLP_0_Layer_1_Linear_0_Transpose_0_axes": None,
        ...
        "w2": [1, 10],
        "_MLP_0_Layer_2_Linear_0_Transpose_0_axes": None,
