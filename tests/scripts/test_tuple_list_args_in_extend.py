...
def test_tuple_argument_3():
    ...
    model += add_model(left="left", right="right")
    model += add_model_2(
        left=(add_model.left.get_shape(), add_model.right.get_shape()),
        right=add_model.left + add_model.right,
        output="output",
    )
...
def test_tuple_argument_4():
    ...
    model += add_model(left="left", right="right")
    model += add_model_2(
        left=(add_model.left.get_shape() * 2, add_model.right.get_shape() * 2),
        right=add_model.left + add_model.right,
        output="output",
    )
...
def test_tuple_argument_5():
    ...
    model += add_model_2(
        left=(
            (add_model.left.get_shape()[0], add_model.left.get_shape()[0]),
            (add_model.left.get_shape()[0], add_model.left.get_shape()[0]),
        ),
        right=add_model.left + add_model.right,
        output="output",
...
def test_list_tuple_mixed_argument_2():
    ...
    left_first_shape = add_model.left.get_shape()[0]
    right_first_shape = add_model.right.get_shape()[0]
